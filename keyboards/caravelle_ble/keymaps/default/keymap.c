...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 //|--------+--------+--------+--------+--------+--------+--------|      |--------+--------+--------+--------+--------+--------+--------|
                               ADJUST,  KC_BSPC, KC_SPC,  KC_LCTL,        KC_RGUI, KC_ENT,  KC_RALT, KC_LANG2 \
 //                           +--------+--------+--------+--------+      +--------+--------+--------+--------+
  ),
 ...
 //|--------+--------+--------+--------+--------+--------+--------|      |--------+--------+--------+--------+--------+--------+--------|
    _______, KC_GRV,  KC_BSLS, KC_MINS, KC_EQL,  KC_TILD, _______,        _______, KC_PIPE, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, _______, \
 //|--------+--------+--------+--------+--------+--------+--------|      |--------+--------+--------+--------+--------+--------+--------|
                               _______, _______, _______, _______,        _______, _______, _______, KC_LANG1 \
 //                           +--------+--------+--------+--------+      +--------+--------+--------+--------+
  ),
